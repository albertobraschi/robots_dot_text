...
This gives you the option to create directives are updated dynamically as your site's content changes.
It's also a bit more fun and easier than having to remember the names of all of the various crawlers and
 the syntax for robots.txt files.
...
remove *robots.txt* from your _/public_ directory
...
Check out the RDocs - robots_dot_text/doc/index.html

For more info on crawler user-agents check out http://www.user-agents.org/

Copyright &copy; 2009 Gavin Morrice, released under the MIT license